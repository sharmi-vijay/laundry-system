...
function sendmobileotpf(phno){
	...
	console.log(phno)
	console.log(massage)
   	const response = fast2sms.sendMessage({authorization:C89SdFXpAJ5taurLOKGkEMlbeYRoVhPs3i6IBqTcfnQD71HNyWun3goMB5FK0QNXcL6dOPVxEIzflRJm,message: massage, numbers: [phno]})
	return mobile_otp;
}
